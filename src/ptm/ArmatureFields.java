...
public class ArmatureFields extends javax.swing.JFrame {
...
Cart cart=new Cart();
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtteeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 160, -1));
        ...
        cd.setText("Core Dia");
        jPanel2.add(cd, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 70, -1));

        bbs.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        bbs.setText("B.B size");
        jPanel2.add(bbs, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 50, -1));

        fbd.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        fbd.setText("F.B.D");
        jPanel2.add(fbd, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 70, -1));

        cbd.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        cbd.setText("C.B.D");
        jPanel2.add(cbd, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 70, -1));

        teeth.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        teeth.setText("Teeth");
        jPanel2.add(teeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 70, -1));

        cl.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        cl.setText("Core Length");
        jPanel2.add(cl, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 90, 70, -1));
        jPanel2.add(txtcl, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 90, 160, -1));
        jPanel2.add(txtbbs, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 90, 160, -1));
        jPanel2.add(txtfbd, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 160, -1));
        jPanel2.add(txtcbd, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 160, -1));
        jPanel2.add(txtshaft, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 130, 160, -1));
        jPanel2.add(txtgodam, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 90, 160, -1));
        jPanel2.add(txtcd, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 90, 160, -1));

        shaft.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        shaft.setText("Shaft");
        jPanel2.add(shaft, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130, 70, -1));

        sd.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        sd.setText("Shaft Dia");
        jPanel2.add(sd, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 130, 70, -1));
        jPanel2.add(txtsd, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 130, 160, -1));
        ...
        Id.setText("Id");
        jPanel2.add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 40, 20));
        jPanel2.add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 160, -1));
    ...
    private void tblspMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblspMouseClicked
        d = (DefaultTableModel) tblsp.getModel();
        int sIndex = tblsp.getSelectedRow();
        ...
        txtcd.setText(d.getValueAt(sIndex, 12).toString());
        txtcl.setText(d.getValueAt(sIndex, 13).toString());
        txtbbs.setText(d.getValueAt(sIndex, 14).toString());
        txtfbd.setText(d.getValueAt(sIndex, 15).toString());
        txtcbd.setText(d.getValueAt(sIndex, 16).toString());
        txtshaft.setText(d.getValueAt(sIndex, 17).toString());
        txtsd.setText(d.getValueAt(sIndex, 18).toString());
        txtteeth.setText(d.getValueAt(sIndex, 19).toString());
    ...
    private void btnaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnaddMouseClicked
        try {
            ...
            String CoreDia = txtcd.getText();
            String CoreLength = txtcl.getText();
            String BBS = txtbbs.getText();
            String FBD = txtfbd.getText();
            String CBD = txtcbd.getText();
            String Shaft = txtshaft.getText();
            String Shaftd = txtsd.getText();
            ...
            pst = con.prepareStatement("INSERT INTO `spare parts`(`Id`, `Name`, `Model No`, `Company`, `Brand`, `C.P`, `W.P`, `R.P`, `Total Quantity`, `Show Room`, `G.D`, `T.C`, `Core.Dia`, `Core.Length`, `B.B.Size`, `F.B.D`, `C.B.D`, `Shaft`, `Shaft.Dia`, `Teeth`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            pst.setString(1, Id);
            ...
            pst.setString(13, CoreDia);
            pst.setString(14, CoreLength);
            pst.setString(15, BBS);
            pst.setString(16, FBD);
            pst.setString(17, CBD);
            pst.setString(18, Shaft);
            pst.setString(19, Shaftd);
            pst.setString(20, Teeth);
            ...
            Logger.getLogger(ArmatureFields.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 String Id = txtid.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `spare parts` SET `Id`=?,`Name`=?,`Company`=?,`Brand`=?,`C.P`=?,`W.P`=?,`R.P`=?,`Total Quantity`=?,`Show Room`=?,`G.D`=?,`T.C`=?,`Core.Dia`=?,`Core.Length`=?,`B.B.Size`=?,`F.B.D`=?,`C.B.D`=?,`Shaft`=?,`Shaft.Dia`=?,`Teeth`=? WHERE `Model No`=?");
             pst.setString(1, Id);
            pst.setString(2, Name);
            pst.setString(20, Modelno);
            ...
            pst.setString(12, CoreDia);
            pst.setString(13, CoreLength);
            pst.setString(14, BBS);
            pst.setString(15, FBD);
            pst.setString(16, CBD);
            pst.setString(17, Shaft);
            pst.setString(18, Shaftd);
            pst.setString(19, Teeth);
            pst.executeUpdate();
 ...
 Cart cart=new Cart();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArmatureFields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ArmatureFields().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel bbs;
    ...
    private javax.swing.JLabel shaft;
    ...
    private javax.swing.JTextField txtshaft;

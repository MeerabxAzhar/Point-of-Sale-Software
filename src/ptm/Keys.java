...
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblk.getColumnModel().getColumn(6);
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 930, 570));
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblk.getColumnModel().getColumn(6);
        if (show.isSelected()) {
...
KeysFields kf=new KeysFields();
kf.setVisible(true);        // TODO add your handling code here:

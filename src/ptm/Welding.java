...
public class Welding extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblw.getColumnModel().getColumn(6);
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        jPanel2.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 10, 50, 20));
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblw.getColumnModel().getColumn(6);
        if (show.isSelected()) {
...
WeldingFields wf=new WeldingFields();
...
sg.setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Welding.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

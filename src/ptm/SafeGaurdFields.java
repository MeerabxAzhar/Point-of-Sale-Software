...
public class SafeGaurdFields extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            Logger.getLogger(SafeGaurdFields.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        tblsg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblsgMouseClicked(evt);
            }
        });
        ...
        jPanel2.add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 110, 180, -1));
    ...
    private void btnaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnaddMouseClicked
         try {
            ...
            pst = con.prepareStatement("INSERT INTO `safe gaurd`(`Id`,`Name`, `Brand`, `Model No`, `Whole Sale`, `R Sale`, `Cost Price`, `Total Quantity`, `Show Room`, `Godam`, `Total Cost`) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
pst.setString(1, Id);
 ...
 String Id = txtid.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `safe gaurd` SET `Id`=?,`Name`=?,`Brand`=?,`Whole Sale`=?,`R Sale`=?,`Cost Price`=?,`Total Quantity`=?,`Show Room`=?,`Godam`=?,`Total Cost`=? WHERE `Model No`=?");
            pst.setString(1, Id);
            pst.setString(2, ItemName);
            pst.setString(3, Brand);
    ...
    private void tblsgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblsgMouseClicked
   d = (DefaultTableModel) tblsg.getModel();
        int sIndex = tblsg.getSelectedRow();
    ...
    }//GEN-LAST:event_tblsgMouseClicked
...
wed.setVisible(true);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SafeGaurdFields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SafeGaurdFields().setVisible(true);
            }
        });
    }

...
public class BladesFields extends javax.swing.JFrame {
 ...
 public void tbl() {
        try {
            ...
            Logger.getLogger(BladesFields.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public BladesFields() {
        initComponents();
...
public void Connect() {
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnbill, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 80, 40));
        ...
        jPanel3.add(btnadd, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 90, 40));
        ...
        jPanel3.add(btnupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 80, 40));
        ...
        tblbf.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblbfMouseClicked(evt);
            }
        });
        ...
        Id.setText("Id");
        jPanel2.add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 110, 40, -1));
    ...
    private void tblbfMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbfMouseClicked
          d = (DefaultTableModel) tblbf.getModel();
        int sIndex = tblbf.getSelectedRow();
    ...
    }//GEN-LAST:event_tblbfMouseClicked
    ...
    try {
            ...
            pst = con.prepareStatement("INSERT INTO `accessories`(`Id`,`Name`, `Brand`, `Model No`, `Whole Sale`, `R Sale`, `Cost Price`, `Total Quantity`, `Show Room`, `Godam`, `Total Cost`) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
pst.setString(1, Id);
 ...
 String Id = txtid.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `accessories` SET `Id`=?,`Name`=?,`Brand`=?,`Whole Sale`=?,`R Sale`=?,`Cost Price`=?,`Total Quantity`=?,`Show Room`=?,`Godam`=?,`Total Cost`=? WHERE `Model No`=?");
            pst.setString(1, Id);
            pst.setString(2, ItemName);
            pst.setString(3, Brand);
 ...
 Cart cart=new Cart();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BladesFields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BladesFields().setVisible(true);
            }
        });
    }

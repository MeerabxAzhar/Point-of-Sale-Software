...
public class Bearing extends javax.swing.JFrame {
Connection con;
 ...
 public void Connect() {
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblb.getColumnModel().getColumn(3);
        if (show.isSelected()) {
...
b.setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bearing.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class RotaryHammer extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblrh.getColumnModel().getColumn(5);
        column.setMinWidth(0);
        column.setMaxWidth(0);
        column.setPreferredWidth(0);
        column.setResizable(false);
        } catch (SQLException ex) {
            Logger.getLogger(RotaryHammer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 public void Connect() {
        try {
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblrh.getColumnModel().getColumn(5);
        if (show.isSelected()) {
...
RotaryHammerfields rhf=new RotaryHammerfields();
rhf.setVisible(true);        // TODO add your handling code here:
...
ot.setVisible(true);          // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RotaryHammer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RotaryHammer().setVisible(true);
            }
        });
    }

...
public class PowerToolss extends javax.swing.JFrame {
 Connection con;
 ...
 public void tbl() {
  ...
  public void Connect() {
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnbill, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 130, 40));
        ...
        jPanel3.add(btnaddup, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 130, 40));
...
System.out.println("Button clicked");  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PowerToolss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PowerToolss().setVisible(true);
            }
        });
    }

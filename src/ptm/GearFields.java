...
public class GearFields extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            pst = con.prepareStatement("select * from `gear`");
            rs = pst.executeQuery();
            ResultSetMetaData rsd = rs.getMetaData();
            d = (DefaultTableModel) tblg.getModel();
            d.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
                ...
                v.add(rs.getString("Teeth"));
                v.add(rs.getString("S.O.D"));
                v.add(rs.getString("S.I.D"));
                v.add(rs.getString("SWidth"));
                v.add(rs.getString("STeeth"));
                v.add(rs.getString("Katr"));
                d.addRow(v);
            }
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        txtkatr = new javax.swing.JTextField();
        ...
        swidth = new javax.swing.JLabel();
        txtswidth = new javax.swing.JTextField();
        steeth = new javax.swing.JLabel();
        txtsteeth = new javax.swing.JTextField();
        ...
        jPanel2.add(txtkatr, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 170, 160, -1));
        ...
        od.setText("O.D");
        jPanel2.add(od, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 70, -1));

        width.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        width.setText("Width");
        jPanel2.add(width, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 90, 50, -1));

        teeth.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        teeth.setText("Teeth");
        jPanel2.add(teeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 70, -1));

        sod.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        sod.setText("S.O.D");
        jPanel2.add(sod, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 70, -1));

        katr.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        katr.setText("Katr");
        jPanel2.add(katr, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 60, -1));
        ...
        jPanel2.add(txtteeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 130, 160, -1));
        jPanel2.add(txtsod, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 130, 160, -1));
        jPanel2.add(txtsid, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 130, 160, -1));
        ...
        sid.setText("S.I.D");
        jPanel2.add(sid, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 130, 70, -1));

        swidth.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        swidth.setText("Width");
        jPanel2.add(swidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 130, 70, -1));
        jPanel2.add(txtswidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 130, 160, -1));

        steeth.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        steeth.setText("Teeth");
        jPanel2.add(steeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 60, -1));
        jPanel2.add(txtsteeth, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 160, -1));

        tblg.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        tblg.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Model No.", "Company", "Brand", "C.P", "W.P", "R.P", "T.Q", "S.R", "G.D", "T.C", "O.D", "I.D", "Width", "Teeth", "S.O.D", "S.I.D", "SWidth", "STeeth", "Katr"
            }
        ));
        tblg.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_ALL_COLUMNS);
        tblg.setShowHorizontalLines(true);
        tblg.setShowVerticalLines(true);
        tblg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblgMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(tblg);

        jPanel2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 1000, 380));

        Id.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        Id.setText("Id");
        jPanel2.add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 170, 30, 20));
        jPanel2.add(txti, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 170, 160, -1));
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
         String txt=txtsearch.getText();
          try {
              if(txt.matches("^[0-9]+$")){
            String query="SELECT * FROM `gear` Where `Model No`="+txt;
                pst=con.prepareStatement(query);
              rs=pst.executeQuery();
              tblg.setModel(DbUtils.resultSetToTableModel(rs));
              }
            else if (txt.matches("^[a-zA-Z0-9]+$")) {
    // Search by ID
    String query = "SELECT * FROM `gear` WHERE `Id` = '" + txt + "'";
    pst = con.prepareStatement(query);
              rs=pst.executeQuery();
              tblg.setModel(DbUtils.resultSetToTableModel(rs));
              }
              ...
              {
              String query="SELECT * FROM `gear` Where `Name` LIKE '%"+txt+"%'";
                pst=con.prepareStatement(query);
              rs=pst.executeQuery();
              tblg.setModel(DbUtils.resultSetToTableModel(rs));
              }
    ...
    private void tblgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblgMouseClicked
        d = (DefaultTableModel) tblg.getModel();
        int sIndex = tblg.getSelectedRow();
        ...
        txtteeth.setText(d.getValueAt(sIndex, 15).toString());
        txtsod.setText(d.getValueAt(sIndex, 16).toString());
        txtsid.setText(d.getValueAt(sIndex, 17).toString());
        txtswidth.setText(d.getValueAt(sIndex, 18).toString());
        txtsteeth.setText(d.getValueAt(sIndex, 19).toString());
        txtkatr.setText(d.getValueAt(sIndex, 20).toString());
    ...
    private void btnaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnaddMouseClicked
        try {
            ...
            String Teeth = txtteeth.getText();
            String SOD = txtsod.getText();
            String SID = txtsid.getText();
            String SW = txtswidth.getText();
            String ST= txtsteeth.getText();
            String Katr= txtkatr.getText();
            ...
            pst = con.prepareStatement("INSERT INTO `gear`(`Id`, `Name`, `Model No`, `Company`, `Brand`, `C.P`, `W.P`, `R.P`, `Total Quantity`, `Show Room`, `G.D`, `T.C`, `O.D`, `I.D`, `Width`, `Teeth`, `S.O.D`, `S.I.D`, `SWidth`, `STeeth`, `Katr`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
            pst.setString(1, Id);
            ...
            pst.setString(13, OD);
            pst.setString(14, ID);
            pst.setString(15, Width);
            pst.setString(16, Teeth);
            pst.setString(17, SOD);
            pst.setString(18, SID);
            pst.setString(19, SW);
            pst.setString(20, ST);
            pst.setString(21, Katr);
            ...
            Logger.getLogger(GearFields.class.getName()).log(Level.SEVERE, null, ex);
        }
  ...
  String Id = txti.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `gear` SET `Id`=?,`Name`=?,`Company`=?,`Brand`=?,`C.P`=?,`W.P`=?,`R.P`=?,`Total Quantity`=?,`Show Room`=?,`G.D`=?,`T.C`=?,`O.D`=?,`I.D`=?,`Width`=?,`Teeth`=?,`S.O.D`=?,`S.I.D`=?,`SWidth`=?,`STeeth`=?,`Katr`=? WHERE `Model No`=?");
             pst.setString(1, Id);
            pst.setString(2, Name);
            pst.setString(21, Modelno);
            ...
            pst.setString(12, OD);
            pst.setString(13, ID);
            pst.setString(14, Width);
            pst.setString(15, Teeth);
            pst.setString(16, SOD);
            pst.setString(17, SID);
            pst.setString(18, SW);
            pst.setString(19, ST);
            pst.setString(20, Katr);
            pst.executeUpdate();
...
System.out.println("Button clicked");  
        int selectedRow = tblg.getSelectedRow();
        if (selectedRow != -1) { // A row is selected  
            String id = tblg.getValueAt(selectedRow, 0).toString();
            String itemName = tblg.getValueAt(selectedRow, 1).toString();
            double price = Double.parseDouble(tblg.getValueAt(selectedRow, 10).toString());
...
ot.setVisible(true);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GearFields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GearFields().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel katr;
    ...
    private javax.swing.JLabel steeth;
    private javax.swing.JLabel swidth;
    ...
    private javax.swing.JTextField txtkatr;
    ...
    private javax.swing.JTextField txtsteeth;
    private javax.swing.JTextField txtswidth;

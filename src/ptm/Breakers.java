...
public class Breakers extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblb.getColumnModel().getColumn(5);
 ...
 public void Connect() {
  ...
  TableColumn hiddenColumn = tblb.getColumnModel().getColumn(5);
        if (show.isSelected()) {
...
Breakersfields brf=new Breakersfields();
brf.setVisible(true);        // TODO add your handling code here:

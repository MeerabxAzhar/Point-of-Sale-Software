...
public class ChuckNut extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblcn.getColumnModel().getColumn(6);
 ...
 public void Connect() {
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblcn.getColumnModel().getColumn(6);
        if (show.isSelected()) {
...
ChuckNutFields cnf=new ChuckNutFields();
cnf.setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChuckNut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

...
public class Bodyfields extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            Logger.getLogger(Bodyfields.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 public void Connect() {
        try {
    ...
    private void initComponents() {
        ...
        tblbody.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblbodyMouseClicked(evt);
            }
        });
        ...
        godam.setText("Godam");
        jPanel2.add(godam, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 90, 70, -1));
    ...
    private void tblbodyMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblbodyMouseClicked
        d = (DefaultTableModel) tblbody.getModel();
        int sIndex = tblbody.getSelectedRow();
    ...
    }//GEN-LAST:event_tblbodyMouseClicked
    ...
    private void btnaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnaddMouseClicked
        try {
            ...
            pst = con.prepareStatement("INSERT INTO `body`(`Id`, `Name`, `Model No`, `Company`, `Brand`, `Cost Price`, `Whole Price`, `Retail Price`, `Total Quantity`, `Show Room`, `Godam`, `Total Cost`, `Details`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)");
pst.setString(1, Id);
 ...
 String Id = txtid.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `body` SET `Id`=?,`Name`=?,`Company`=?,`Brand`=?,`Cost Price`=?,`Whole Price`=?,`Retail Price`=?,`Total Quantity`=?,`Show Room`=?,`Godam`=?,`Total Cost`=?,`Details`=? WHERE `Model No`=?");
           pst.setString(1, Id);
            pst.setString(2, ItemName);
 ...
 Cart cart=new Cart();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bodyfields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bodyfields().setVisible(true);
            }
        });
    }

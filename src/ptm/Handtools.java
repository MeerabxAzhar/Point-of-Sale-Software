...
public class Handtools extends javax.swing.JFrame {
 Connection con;
...
//     private Cart cart;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblht.getColumnModel().getColumn(6);
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        if (tblht.getColumnModel().getColumnCount() > 0) {
            tblht.getColumnModel().getColumn(0).setResizable(false);
            tblht.getColumnModel().getColumn(1).setResizable(false);
        }

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 1000, 530));
        ...
        jPanel2.add(show, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 10, 50, 20));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, 1040, 630));
        ...
        jPanel3.add(btnaddup, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 130, 40));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 70, 200, 630));
        ...
        jPanel1.add(btncart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 20, 50, 40));
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblht.getColumnModel().getColumn(6);
        if (show.isSelected()) {
 ...
 public void updateq(String idd, int quantityy) {
    try {
        pst = con.prepareStatement("UPDATE `hand tools` SET `Quantity` = `Quantity` - ? WHERE `Product ID` = ?");
        pst.setInt(1, quantityy);  // Set quantityy as an integer
        pst.setString(2, idd);  // Set idd as an integer
        pst.executeUpdate();
...
HTAdd hta=new HTAdd();
hta.setVisible(true);        // TODO add your handling code here:
...
w.setVisible(true);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Handtools.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

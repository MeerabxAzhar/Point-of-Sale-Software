...
public class BitsFields extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            pst = con.prepareStatement("select * from `bits`");
            rs = pst.executeQuery();
            ...
            Logger.getLogger(BitsFields.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
 ...
 public void Connect() {
    ...
    private void initComponents() {
        ...
        lblwholesale = new javax.swing.JLabel();
        lblretailsale = new javax.swing.JLabel();
        lblcostprice = new javax.swing.JLabel();
        lblshowroom = new javax.swing.JLabel();
        lblgodam = new javax.swing.JLabel();
        ...
        lblptbill = new javax.swing.JLabel();
        lblptadd = new javax.swing.JLabel();
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 930, 430));

        lblitemname.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblitemname.setText("Item Name");
        jPanel2.add(lblitemname, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 90, -1));

        lblbrand.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblbrand.setText("Brand");
        jPanel2.add(lblbrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 20, 70, -1));

        lblmodel.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblmodel.setText("Model No.");
        jPanel2.add(lblmodel, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 20, 80, -1));

        lblwholesale.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblwholesale.setText("Whole Sale");
        jPanel2.add(lblwholesale, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 90, -1));

        lblretailsale.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblretailsale.setText("Retail Sale");
        jPanel2.add(lblretailsale, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 70, -1));

        lblcostprice.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblcostprice.setText("Cost Price");
        jPanel2.add(lblcostprice, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 70, 80, -1));

        lblshowroom.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblshowroom.setText("Show Room");
        jPanel2.add(lblshowroom, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 90, -1));

        lblgodam.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        lblgodam.setText("Godam");
        jPanel2.add(lblgodam, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, 60, -1));
        ...
        jPanel2.add(txtin, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 180, -1));
        jPanel2.add(txtmn, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, 180, -1));
        jPanel2.add(txtws, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 70, 180, -1));
        jPanel2.add(txtrs, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, 180, -1));
        jPanel2.add(txtcp, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 70, 180, -1));
        jPanel2.add(txtsr, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 120, 180, -1));
        jPanel2.add(txtgodam, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 120, 180, -1));

        combobrand.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Choose a Brand", " " }));
        jPanel2.add(combobrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, 180, -1));

        jPanel3.setBackground(new java.awt.Color(0, 51, 102));
        jPanel3.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblptbill.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        lblptbill.setForeground(new java.awt.Color(255, 255, 255));
        lblptbill.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-bill-24.png"))); // NOI18N
        lblptbill.setText("Bill");
        jPanel3.add(lblptbill, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 130, 40));

        lblptadd.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        lblptadd.setForeground(new java.awt.Color(255, 255, 255));
        lblptadd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-add-24.png"))); // NOI18N
        lblptadd.setText("Add");
        jPanel3.add(lblptadd, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 130, 40));
        ...
        jPanel3.add(lblptupdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 130, 40));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 70, 130, 630));

        Id.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        Id.setText("Id");
        jPanel2.add(Id, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 120, 40, -1));
        jPanel2.add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 120, 180, -1));
    ...
    private void txtsearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearchKeyReleased
          ...
          try {
              if(txt.matches("^[0-9]+$")){
            String query="SELECT * FROM `bits` Where `Model No`="+txt;
    ...
    // Search by ID
    String query = "SELECT * FROM `bits` WHERE `Id` = '" + txt + "'";
    pst = con.prepareStatement(query);
              rs=pst.executeQuery();
              tblb.setModel(DbUtils.resultSetToTableModel(rs));
              }
              ...
              {
              String query="SELECT * FROM `bits` Where `Name` LIKE '%"+txt+"%'";
                pst=con.prepareStatement(query);
              rs=pst.executeQuery();
              tblb.setModel(DbUtils.resultSetToTableModel(rs));
              }
               if (txt.isEmpty()) {
    String query = "SELECT * FROM `bits`";
    pst = con.prepareStatement(query);
    rs = pst.executeQuery();
    tblb.setModel(DbUtils.resultSetToTableModel(rs));}
            } catch (SQLException ex) {
    ...
    private void btnaddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnaddMouseClicked
       try {
            ...
            pst = con.prepareStatement("INSERT INTO `bits`(`Id`,`Name`, `Brand`, `Model No`, `Whole Sale`, `R Sale`, `Cost Price`, `Total Quantity`, `Show Room`, `Godam`, `Total Cost`) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
pst.setString(1, Id);
...
d = (DefaultTableModel) tblb.getModel();
 ...
 String Id = txtid.getText();
            ...
            int TotalQuantity = Integer.parseInt(txtsr.getText()) + Integer.parseInt(txtgodam.getText());
            Double TotalCost = Double.parseDouble(txtcp.getText()) * TotalQuantity;
            pst = con.prepareStatement("UPDATE `bits` SET `Id`=?,`Name`=?,`Brand`=?,`Whole Sale`=?,`R Sale`=?,`Cost Price`=?,`Total Quantity`=?,`Show Room`=?,`Godam`=?,`Total Cost`=? WHERE `Model No`=?");
            pst.setString(1, Id);
            pst.setString(2, ItemName);
            pst.setString(3, Brand);
 ...
 Cart cart=new Cart();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BitsFields.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BitsFields().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblgodam;
    private javax.swing.JLabel lblht;
    private javax.swing.JLabel lblitemname;
    private javax.swing.JLabel lblmodel;
    private javax.swing.JLabel lblpt;
    private javax.swing.JLabel lblptadd;
    private javax.swing.JLabel lblptbill;
    private javax.swing.JLabel lblptupdate;
    private javax.swing.JLabel lblretailsale;
    private javax.swing.JLabel lblshowroom;
    private javax.swing.JLabel lblsp;
    private javax.swing.JLabel lblwholesale;

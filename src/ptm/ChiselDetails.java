...
public class ChiselDetails extends javax.swing.JFrame {
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblcd.getColumnModel().getColumn(6);
 ...
 public void Connect() {
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblcd.getColumnModel().getColumn(6);
        if (show.isSelected()) {
...
ChiselFields chf=new ChiselFields();
chf.setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChiselDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChiselDetails().setVisible(true);
            }
        });
    }

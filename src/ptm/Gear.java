...
public class Gear extends javax.swing.JFrame {
Connection con;
 ...
 public void tbl() {
        try {
            ...
            while (rs.next()) {
             ...
             TableColumn column = tblg.getColumnModel().getColumn(5);
 ...
 public void Connect() {
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        ...
        TableColumn hiddenColumn = tblg.getColumnModel().getColumn(5);
        if (show.isSelected()) {
...
ot.setVisible(true);         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
